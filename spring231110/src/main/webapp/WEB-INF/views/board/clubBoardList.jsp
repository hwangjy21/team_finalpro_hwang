	     ...
	     <div class="box2">
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">${clubNm} 게시판</h6>
                        </div>
                        <div class="card-body">
                      
                            <div class="table-responsive">
                            <form action="/board/clubBoardList">
                                ...
                                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                    ...
                                    <tbody>
                                   <c:forEach items="${clubBoardList}" var="bvo">
                                        <tr>
                                          <td>${bvo.bno}</td> 
					...
					<div id="navBox">
						<ul class="pagination">
							<li class="page-item ${(ph.prev ne true)? 'disabled':''}">
								<a class="page-link" href="/board/clubBoardList?pageNo=${ph.startPage-1}&qty=${ph.pgvo.qty}&type=${ph.pgvo.type}&keyword=${ph.pgvo.keyword}" aria-label="Previous"> 
									<span aria-hidden="true">&laquo;</span>
								</a>
							</li>
							<c:forEach begin="${ph.startPage}" end="${ph.endPage}" var="i">
								<li class="page-item">
									<a class="page-link" href="/board/clubBoardList?pageNo=${i}&qty=${ph.pgvo.qty}&type=${ph.pgvo.type}&keyword=${ph.pgvo.keyword}">${i}</a>
								</li>
							</c:forEach>
							<li class="page-item ${(ph.next ne true)? 'disabled':''}">
								<a class="page-link" href="/board/clubBoardList?pageNo=${ph.endPage+1}&qty=${ph.pgvo.qty}&type=${ph.pgvo.type}&keyword=${ph.pgvo.keyword}" aria-label="Next"> 
